Shader "Scatterer/PQS/Sphere Projection SURFACE QUAD (AP) " {
	Properties {
...
ahaaaaaakgakbaaaabaaaaaamgaabaaaabaaaaaadoaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 9[_fogColorRamp] 2D 9 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 7[_snowMultiTex] 2D 7
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
"
				...
				SubProgram "opengl " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_ShadowMapTexture] 2D 10 "3.0-!!ARBfp1.0
PARAM c[31] = { program.local[0..28],
		{ 0, 2.718282, 1, 0.5 },
		{ 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_ShadowMapTexture] 2D 10 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
iccabaaaaaaaaaaabkiacaaaaaaaaaaabbaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 11[unity_Lightmap] 2D 11 "3.0-!!ARBfp1.0
PARAM c[29] = { program.local[0..26],
		{ 2.718282, 1, 0.5, 2 },
		{ 3, 8 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_ShadowMapTexture] 2D 10
					SetTexture 11[unity_Lightmap] 2D 11 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
aaaaaaaadoaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightTexture0] 2D 10 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightTexture0] 2D 10 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
aaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaaaaaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 11[_LightTextureB0] 2D 11 "3.0-!!ARBfp1.0
PARAM c[30] = { program.local[0..27],
		{ 0, 0.5, 2.718282, 1 },
		{ 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightTexture0] 2D 10
					SetTexture 11[_LightTextureB0] 2D 11 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
aaaaaaaadgaaaaaficcabaaaaaaaaaaaabeaaaaaaaaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 11[_LightTexture0] CUBE 11 "3.0-!!ARBfp1.0
PARAM c[30] = { program.local[0..27],
		{ 0, 2.718282, 1, 0.5 },
		{ 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightTextureB0] 2D 10
					SetTexture 11[_LightTexture0] CUBE 11 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
aaaaaaaaapaaaaaaogikcaaaaaaaaaaaapaaaaaadoaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightBuffer] 2D 10 "3.0-!!ARBfp1.0
PARAM c[29] = { program.local[0..26],
		{ 2.718282, 1, 0.5, 2 },
		{ 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 8[_steepTex] 2D 8
					SetTexture 9[_fogColorRamp] 2D 9
					SetTexture 10[_LightBuffer] 2D 10 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
dgaaaaagiccabaaaaaaaaaaabkiacaaaaaaaaaaaanaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 10[_LightBuffer] 2D 10
					SetTexture 11[unity_Lightmap] 2D 11
					SetTexture 12[unity_LightmapInd] 2D 12 "3.0-!!ARBfp1.0
PARAM c[30] = { program.local[0..27],
		{ 2.718282, 1, 0.5, 2 },
		{ 3, 8 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 10[_LightBuffer] 2D 10
					SetTexture 11[unity_Lightmap] 2D 11
					SetTexture 12[unity_LightmapInd] 2D 12 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
