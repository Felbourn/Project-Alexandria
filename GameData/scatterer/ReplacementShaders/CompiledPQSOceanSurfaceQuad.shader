Shader "Scatterer/PQS/Ocean Surface Quad" {
	Properties {
...
doaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 2[_fogColorRamp] 2D 2 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 0[_WaterTex] 2D 0
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
...
aaaaaaaabkaabaaaacaaaaaadkaabaaaadaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[unity_Lightmap] 2D 3 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[unity_Lightmap] 2D 3 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
bkaabaaaaaaaaaaaakaabaaaaaaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[unity_Lightmap] 2D 3
					SetTexture 4[unity_LightmapInd] 2D 4 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[unity_Lightmap] 2D 3
					SetTexture 4[unity_LightmapInd] 2D 4 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
akaabaaaacaaaaaaakaabaaaaaaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_ShadowMapTexture] 2D 3 "3.0-!!ARBfp1.0
PARAM c[21] = { program.local[0..18],
		{ 2.718282, 1, 0.5, 2 },
		{ 3, 0, 128 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_ShadowMapTexture] 2D 3 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
acaaaaaackaabaaaacaaaaaadoaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 4[unity_Lightmap] 2D 4 "3.0-!!ARBfp1.0
PARAM c[17] = { program.local[0..14],
		{ 2, 3, 1, 2.718282 },
		{ 0.5, 8 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_ShadowMapTexture] 2D 3
					SetTexture 4[unity_Lightmap] 2D 4 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
"
				...
				SubProgram "opengl " {
					...
					SetTexture 3[_ShadowMapTexture] 2D 3
					SetTexture 4[unity_Lightmap] 2D 4
					SetTexture 5[unity_LightmapInd] 2D 5 "3.0-!!ARBfp1.0
PARAM c[23] = { program.local[0..17],
		{ 2, 3, 1, 2.718282 },
		{ 0.5, 0.57735026, 8, 0 },
		{ -0.40824828, -0.70710677, 0.57735026, 128 },
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 3[_ShadowMapTexture] 2D 3
					SetTexture 4[unity_Lightmap] 2D 4
					SetTexture 5[unity_LightmapInd] 2D 5 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
egaabaaaaaaaaaaadoaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightTexture0] 2D 3 "3.0-!!ARBfp1.0
PARAM c[21] = { program.local[0..18],
		{ 0, 128, 1, 2.718282 },
		{ 0.5, 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightTexture0] 2D 3 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
doaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 4[_LightTextureB0] 2D 4 "3.0-!!ARBfp1.0
PARAM c[21] = { program.local[0..18],
		{ 0, 128, 1, 2.718282 },
		{ 0.5, 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightTexture0] 2D 3
					SetTexture 4[_LightTextureB0] 2D 4 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
doaaaaab"
				...
				SubProgram "opengl " {
					...
					SetTexture 4[_LightTexture0] CUBE 4 "3.0-!!ARBfp1.0
PARAM c[21] = { program.local[0..18],
		{ 0, 128, 1, 2.718282 },
		{ 0.5, 2, 3 } };
TEMP R0;
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightTextureB0] 2D 3
					SetTexture 4[_LightTexture0] CUBE 4 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
...
bdaaaaaadoaaaaab"
			...
			Program "fp" {
				SubProgram "opengl " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightBuffer] 2D 3 "3.0-!!ARBfp1.0
...
"
				...
				SubProgram "d3d9 " {
					...
					SetTexture 1[_WaterTex1] 2D 1
					SetTexture 2[_fogColorRamp] 2D 2
					SetTexture 3[_LightBuffer] 2D 3 "ps_3_0
dcl_2d s0
dcl_2d s1
dcl_2d s2
dcl_2d s3
